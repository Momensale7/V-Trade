...
export default function Register() {
  ...
  const validationSchema = Yup.object({
    name: Yup.string()
      .min(3, "Name lengh must be greater than or equal 3")
      .max(20, "Name length must be less than or equal 20")
      .required("name is required"),
    phone: Yup.string()
      .matches(/^(002)?01[0125][0-9]{8}/, "enter a valid egyptian number")
        ...
        <div className="grid grid-cols-12">
          <div className="md:col-span-5 col-start-2 col-span-10 md:col-start-1  shadow-2xl border p-5 ">
            ...
            <form onSubmit={formik.handleSubmit}>
              ...
              {errorMessage ? (
                <p className="bg-red-300  text-white p-1 rounded-md my-4 text-sm ">
                  {errorMessage}
                </p>
              ) : null}
              <button
